...
## <span style="color:brown; font-style:italic;"> Challenge Task 1: Recover Figure 1 — Post-Surgical Outcomes by Patient</span>
...
ax.text(0.02, 0.98, f'○ Doc Dreamy: {dreamy_mean:.2f}', 
        transform=ax.transAxes, fontsize=11, 
        verticalalignment='top', color='#4E79A7', 
        bbox=dict(boxstyle='round', facecolor='white', alpha=0.8))
ax.text(0.02, 0.92, f'△ Doc Duck: {duck_mean:.2f}', 
        transform=ax.transAxes, fontsize=11, 
        verticalalignment='top', color='#E15759', 
        bbox=dict(boxstyle='round', facecolor='white', alpha=0.8))
...
## <span style="color:brown; font-style:italic;"> Challenge Task 2: Recover Figure 2 — Randomized Assignment Outcomes</span>
...
## <span style="color:brown; font-style:italic;"> Challenge Task 3: Recover Figure 3 — Outcomes by Patient Severity (Stratification)</span>
...
ax.text(x_max, dreamy_mean, f'  {dreamy_mean:.2f}', 
        fontsize=11, color='#4E79A7', fontweight='bold',
        verticalalignment='center', zorder=4,
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', 
                  edgecolor='#4E79A7', alpha=0.9))
ax.text(x_max, duck_mean, f'  {duck_mean:.2f}', 
        fontsize=11, color='#E15759', fontweight='bold',
        verticalalignment='center', zorder=4,
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', 
                  edgecolor='#E15759', alpha=0.9))
...
ax.set_xlim(severity_min - 0.5, severity_max + 0.5)
ax.set_ylim(0, 7)
